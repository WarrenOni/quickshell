...
PopupWindow{
    ...
    Process {
        ...
        stdout: StdioCollector {
            ...
            onRead: bluetoothData => {
                try {
                    bluetoothData = JSON.parse(data);
                } catch (e) {
                    console.log("bluetooth parse error", e);
                }
            }
        }
    }
        ...
        SwipeView {
            ...
            Item {
                ...
                Ripple {
                    ...
                    running: {
                        menu.open ? (P_data.bluetoothData.power === "on" ? (P_data.bluetoothData.connected ? true : false) : false) : false;
                    }
                    anchors.centerIn: parent
                }
